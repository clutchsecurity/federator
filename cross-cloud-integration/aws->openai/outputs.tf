...
output "aws_federation_role_arn" {
  description = "ARN of the IAM role used for OpenAI federation"
...
output "get_token_command" {
  ...
  value       = "aws sts get-web-identity-token --audience https://api.openai.com/v1 --signing-algorithm ES384 --duration-seconds 300"
}
